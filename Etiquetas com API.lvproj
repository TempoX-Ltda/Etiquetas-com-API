...
<Project Type="Project" LVVersion="20008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Support VIs" Type="Folder">
			<Item Name="Add cod na fila.vi" Type="VI" URL="../Support VIs/Add cod na fila.vi"/>
			<Item Name="Add Peça.vi" Type="VI" URL="../Support VIs/Add Peça.vi"/>
			<Item Name="Check Loop Error.vi" Type="VI" URL="../../Sistema-de-captura-de-imagens/Sistema de Captura de Imagens/support/Check Loop Error.vi"/>
			<Item Name="Cluster de envio.ctl" Type="VI" URL="../Type Defs/Cluster de envio.ctl"/>
			<Item Name="Cluster de posição.ctl" Type="VI" URL="../Type Defs/Cluster de posição.ctl"/>
			<Item Name="Error Handler - Event Handling Loop.vi" Type="VI" URL="../../Sistema-de-captura-de-imagens/Sistema de Captura de Imagens/support/Error Handler - Event Handling Loop.vi"/>
			<Item Name="Error Handler - Message Handling Loop.vi" Type="VI" URL="../../Sistema-de-captura-de-imagens/Sistema de Captura de Imagens/support/Error Handler - Message Handling Loop.vi"/>
			<Item Name="Match.vi" Type="VI" URL="../Support VIs/Match.vi"/>
			<Item Name="Message Queue.lvlib" Type="Library" URL="../../Sistema-de-captura-de-imagens/Sistema de Captura de Imagens/support/Message Queue/Message Queue.lvlib"/>
			<Item Name="Procura ponto médio.vi" Type="VI" URL="../Support VIs/Procura ponto médio.vi"/>
			<Item Name="Remover Peça.vi" Type="VI" URL="../Support VIs/Remover Peça.vi"/>
		</Item>
		<Item Name="Main2.vi" Type="VI" URL="../Fotos teste/Main2.vi"/>
